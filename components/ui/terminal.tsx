...
/* eslint-disable react-hooks/set-state-in-effect -- MagicUI terminal sequencing */
...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 flex w-full max-w-lg flex-col overflow-hidden rounded-xl border",
        className
      )}
    >
      ...
      <pre className="m-0 min-h-0 flex-1 overflow-hidden p-4">
        <code className="block h-full min-h-0 overflow-hidden">
          {wrappedChildren}
        </code>
      </pre>
    </div>
